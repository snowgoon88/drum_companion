* __CURRENT__ : Change BPM on the fly ?
* TODO [7/11] linux
...
** TODO Why when STOP, beat nb in BeatSlider is not 1 but 4 ??
** TODO Why PatternGUI is not updated when BPM is globally changed ?
