* __CURRENT_: display frame/sec ds ImGUI
...
*** TODO toStart button
*** TODO [1/2] sliding line synchronized
**** DONE red vert line at pCursor
**** TODO sliding ??
** DONE [1/2] loop enabled
*** DONE with ONE loop
...
*** DONE loop :       ENTER
*** TODO hint or textline about Key shorcuts
** several wavs
* IDEA [28/34] linux
