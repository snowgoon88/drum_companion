* __CURRENT__ : analyze looper sequence construction
* TODO [3/5] linux
...
*** DONE apply changes to PatternAudiojxuàççççç _ÀÇR_RÇAQ_DCUÀ=
...
** TODO [/] mix hh soundaiuoooeue"ç"&)é"
...
** TODO When reading Looper from file, might need to delete some existing patternsOS)))FDO O<
NB 744
WCBWBDW WC WCGFGGGGGGGGGG
* [6/9] WINDOWS
